       ...
       <td class="p-3 pl-0">
         <div class="flex items-center">
           ...
           <div class="flex flex-col justify-start">
             <a href="javascript:void(0)" class="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary">{{$etudiant->name}} </a>
           </div>
         </div>
       </td>
       <td class="p-3 pr-0 text-end">
         <span class="font-semibold text-light-inverse text-md/normal">{{ $etudiant->profil?->filiere }}</span>
       </td>
       <td class="p-3 pr-0 text-end">
